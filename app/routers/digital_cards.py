...
from app.domain.digital_card.body_requests import (
...
async def issue_digital_code(
    body: Annotated[
        IssueDigitalCardStandardBody,
        Body(title="Issue a new digital gift card", description=""),
    ],
):
...
async def issue_reward(
    body: Annotated[
        IssueReward,
        Body(title="Issue a new Reward Pass by email or url", description=""),
    ],
):
    response = await services.issue_digital_code(body)
...
async def cancel_by_url(
    body: Annotated[
        CancelDigitalUrlBody,
        Body(title="Cancel an issued digital gift card", description=""),
    ],
):
...
async def order(
    body: Annotated[
        OrderDigitalCodeAsyncBody,
        Body(title="Create an asynchronous request for a gift code.", description=""),
    ],
):
