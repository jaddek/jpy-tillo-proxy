...
TILLO_HTTP_CLIENT_OPTIONS = {
    ...
    "limits": Limits(
        ...
        max_keepalive_connections=os.getenv('TILLO_HTTP_CLIENT_OPTIONS_MAX_KEEPALIVE_CONNECTIONS', 20)
    ),
    'base_url': os.getenv('TILLO_HOST', ""),
    "max_redirects": os.getenv('TILLO_HTTP_CLIENT_OPTIONS_MAX_REDIRECTS', 20),
    "default_encoding": os.getenv("TILLO_HTTP_CLIENT_OPTIONS_DEFAULT_ENCODING", "utf-8"),
}
